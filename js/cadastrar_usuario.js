...
modal("myModal","btn-cadastrar");


// QUANDO CLICAR NO BOTÃO DE CADASTRAR CHAMA A FUNÇÃO DE VAILDAÇÃO
$(".btn-submit").on('click', validacao);


// FUNÇÃO DE VALIDAÇÃO DOS INPUTS DO FORM DE CADASTRAR USUARIO
function validacao() {

    var formcadastro, cpf, usuario, email, nome, matricula, setor, cont;
