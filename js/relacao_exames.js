$(document).ready(function(){
  var inputChecked = $("input[name='ok']");
  checkedRelacaoExames(inputChecked);
});

$("input[name='ok']").click(function(){
  checkedRelacaoExames($(this));
});

function checkedRelacaoExames(e){
  if( e.is(':checked') ){
    e.closest("tr").addClass("ok");
  }else{
    e.closest("tr").removeClass("ok")
  }
}


// CHAMA MODAL E ABRI O MODAL AO CLICAR NO BOTÃO OBS: modal("id do modal","id do botao para abrir")
modal("myModal","btn-emitir");
